...
export default function PageZ06LT6 () {
  const sections = [
    {
    ...
    <div className="rowPage">
      ...
      <div className="col-6">
        ...
        <h5>
          ...
          The Z06 LT6 670-hp V-8 engine is a landmark achievement. Hagerty,
          February 21, 2022
        </h5>
        ...
        <p>
          ...
          The LT6 is a 5.5-liter, naturally-aspirated, flat-plane V8 engine that
          debuted in the 2023 Chevrolet Corvette Z06, known for its high-revving
          nature and high power output, making it the most powerful
          naturally-aspirated production V8 engine of all time.
        </p>
        <p> Here's a deeper dive into the LT6 engine: </p>

        <h3>

          <b> Development and Relationship to Other Engines: </b>
        </h3>
        ...
        <div>
         ...
         <Link to="https://vette-vues.com/5-5l-dohc-v-8-engine-press-release/">
                      2. Vette Vues Magazine, "2023 C8 Corvette Z06 LT6 Debut: 5.5L DOHC V-8 Engine"
                    </Link>
