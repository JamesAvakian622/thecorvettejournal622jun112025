...
export default function PageZ06Hard() {
  // const sections = [
  //   {
...
<p>
  <b> C8 Z06 HTC....better than the Coupe?</b>

  <div style={{position: 'relative', paddingTop: '56.25%'}}>
    <ReactPlayer
      url="  https://www.youtube.com/watch?v=Ur2ULXmz_G8"
      width="100%"
      height="100%"
  ...
  <div style={{position: 'relative', paddingTop: '56.25%'}}>
    ...
    />
          ...
          <div>
            ...
            <Link to="https://www.youtube.com/shorts/2T0hUwLzZgw">    1. Z05 Hardtop, The-Luxurious-Motor            </Link>
