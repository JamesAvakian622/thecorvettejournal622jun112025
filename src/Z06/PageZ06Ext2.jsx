      ...
      <div className="rowPage">
        ...
        <div className="col-6">
          <div className="center">
            ...
            <h1>
              <b>
                The <Link to="/Z06">2025 Corvette Z06 </Link> Exterior,
                additional 3" in front of car
              </b>
            </h1>
          </div>

          <p> The 2025 Chevrolet Corvette Z06 has external parts </p>

          <p>This is for Chevrolet OEM Options</p>

          <p>
            The low wing for the Corvette Z06 in body color or carbon flash
            finish.
          </p>
          ...
          <p> The 2025 Chevrolet Corvette Z06 Z07 has the high wing. </p>
          <div className="responsive">
            <div className="gallery100">
              <a target="_blank" rel="noopener noreferrer" href={Sting21}>
                <img
