...
export default function PageZ06Z07() {
  return (
    <>
      <div className="rowPage">
        ...
        <div className="col-6">
          <h1>
            <b> The Corvette Z06 Z07</b>
          </h1>

          <h1>
            <b> "A Track Focus Steet Car"</b>
          </h1>
            <CarouselIntro />
            <h3>            <b> Chevrolet, The 2025 Chevrolet Corvette Z06 With The Z07 Package</b>          </h3>
