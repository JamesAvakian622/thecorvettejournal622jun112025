...
export default function PageZ06Features() {
      ...
      <div className="rowPage">
        ...
        <div className="col-6">
          ...
          <div className="responsive">
            <div className="gallery">
              <a target="_blank" rel="noopener noreferrer" href="/z06logo.png">
                <img src="/z06logo.png" alt="Cinque Terre" width={"100%"} height={"100%"}
                />
          ...
          <div className="center">
            <h4> Corvette Z06 Logo   </h4>
          </div>
          <br />

          <Link to="/Z06"> <h2> The 2025 Corvette Z06 Sports Car   </h2>  </Link>    <p>has a variety of options to customize your ride to your liking.
