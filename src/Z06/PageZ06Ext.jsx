...
export default function PageZ06Ext () {
  const sections = [
    {
      ...
      <div className="col-6">
        <div className="center">
          ...
          <p>
            ...
            15" rotor and electtrionic suspension for the ultime grip on the
            road. produced. Here are some highlights:
          </p>
          ...
          <div>
            ...
            <Link to="https://www.hagerty.com/media/maintenance-and-tech/lt6-breakdown-the-z06s-670-hp-v-8-is-a-landmark-achievement/          ">              Reference: 1. Hagerty, The LT6 A Landmark Achievement
            </Link>
            <Link to="https://vette-vues.com/5-5l-dohc-v-8-engine-press-release/">              2. Vette Vues Magazine
            </Link>
            <Footer />
          </div>
