...
export default function ZC8Histb() {
  return (
    <>
      <div className="rowPage">
        ...
        <ButtonGridWheels /> */}
            ...
            <h2>
              <h2>
                <b>The Executive Chief Engineers</b>
              </h2>
            </h2>
            <h3>
              <h2>
          ...
          <p>
              ...
              <p>C1 (1953-1962): Zora Arkus-Duntov</p>
            ...
            <br />
            <p>During The C1 Generation</p>

            <p>
Zora Arkus-Duntov worked at Chevrolet long before the Iso Grifo was developed. He joined General Motors in 1953 
and became inStumental in shaping the Corvette, earning the title "Father of the Corvette". 
</p>
<p> To help start the American Muscle Sports Car movement in the sixties, Zora help with the Iso Grifo, 
  an Italian-American grand tourer, was introduced in the 1960s, well after Arkus-Duntov had already made his mark at Chevrolet.
Zora helped sell General Motors, Chevrolet Division, Crate Motor sales to stimulate sales and really was the 
beginning of the American Muscle Car movement.
