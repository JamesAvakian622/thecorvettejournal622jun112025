...
export default function LT7() {
  return (
    <>
      <div className="rowPage">
        <CarouselZR1 />
        <div className="col-3 menuSide">
          <SidebarZR1 />
        </div>

        <div className="col-6">
          <h1>
            <b> The Corvette LT7 Engine </b>
          </h1>
...
Valvetrain timing and lift profile optimization
          ...
          <div>
            <h3>
              <b> References </b>
               ...
               <Link to="https://gmauthority.com/blog/gm/gm-engines/lt7/#google_vignette        ">
             1. GM Authority, "GM 5.5 Liter LT7 Twin-Turbo V8 Engine"
            </Link>
            <Link to="https://www.hagerty.com/media/maintenance-and-tech/lt6-breakdown-the-z06s-670-hp-v-8-is-a-landmark-achievement/          ">
              Reference: 2. Hagerty, The LT6 A Landmark Achievement
            </Link>
            <Link to="https://vette-vues.com/5-5l-dohc-v-8-engine-press-release/">
              3. Vette Vues Magazine
            </Link>
