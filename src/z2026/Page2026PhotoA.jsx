...
import Footer from "../Footer";
 export default function Page2026PhotoA() {
  ...
  return (
    <>
      ...
      <h1 className="text">2026 Corvette Photo Album</h1>

<h4> Stingray  E-Ray, Z06    and ZR1      </h4>


   <h5>Click the images for 100% siing.</h5>
      </div>
      ...
      <div className="responsive">
        <div className="gallery100">
          ...
          <div className="desc">Corvette 2026</div>
        </div>
      </div>
      <div className="responsive">
        <div className="gallery100">
