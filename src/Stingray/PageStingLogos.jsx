...
export default function PageStingLogos() {
  const sections = [
...
<h1>    
            <Link to="PageStingPhotoZ"> Seventy Years Of Stingray Logos</Link>
...
<br /><br /><br /><br />
        ...
        <h1>
             <p>1953 Corvette Cars, Vette Logo, Vette Text Logo</p>
        </h1>
       ...
       <h2>
        ...
        <div className="responsive">
          <div className="gallery">
            <a target="_blank" rel="noopener noreferrer" href="/1953logo.png">
              <img src="/1953logo.png" alt="Cinque Terre" width={"100%"} height={"100%"} />
        ...
        <p>
          How did "CORVETTE" get its Name?</p> <p>
...
{/* 
        ...
        <div>
          ...
          <Link to=" https://www.carlogos.org/car-brands/chevrolet-corvette-logo.html">5. GM Authority, "The Chevrolet LT1 Engine, Predcessor To LT2"</Link>
