...
<p>
n the 2004 redesign, the Corvette logo underwent a transformation to achieve a neater and more compact design. One noticeable change was the removal of the circle that was present in the previous design, which resulted in a cleaner and more Steamlined appearance.
  ...
  <div className='desc'>Source: Wikipedia.com</div>
          ...
          <div className='responsive'>
            <div className='gallery100'>
              ...
              <div className='desc'> Corvette C6 Interior</div>
            </div>
          </div>
