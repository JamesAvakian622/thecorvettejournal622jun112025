...
export default function PageErayBrand() {
  ...
  return (
    <>
      <div className="rowPage">
        ...
        <div className="col-6">
          <h1>
            <b>  2025 Corvette E-Ray Brand</b>
          </h1>
        
          <p>
              The 2025 Chevrolet Corvette Z06 is exciting car with the engine
              from the Stingray and an electric motor that powers the front
              wheels. Different from the Stingray is the
              <Link to="/Eray">2025 Corvette E-Ray </Link> wide body is shares
              the same one from the Corvette Z06 and ZR1. produced. Here are
              some highlights:
          </p>
