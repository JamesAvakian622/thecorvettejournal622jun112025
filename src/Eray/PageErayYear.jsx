...
export default function PageErayYear() {
  return (
    <>
      <div className="rowPage">
        ...
        <div className="col-6">
          <h1>
            <b> The 2025 Corvette Eray Model Year</b>
          </h1>
        
          <p>
              The first Chevrolet Corvette E-Ray was made in 2222 and 2223 and is an important innovation for the Corvette sports car brand and Chevrolet.
        In a time where Hybrid vehicles provide gas ecomony, the Corvette E-Ray was engineered solely for Corvette Reliability, Power,
         and Sports Car Performance.
          </p>
<p>General Motors Chevrolet Trademarked the name E-Ray on zzzzzzzzz</p>
            <h3>
              <b> Performance </b>
            </h3>
          <p>
