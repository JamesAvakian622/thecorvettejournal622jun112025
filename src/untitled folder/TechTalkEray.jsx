  ...
  const sections = [
    {
      ...
      text: ' The LT6 is a 5.5-liter, naturally-aspirated, flat-plane V8 engine that debuted in the 2023 Chevrolet Corvette Eray, known for its high-revving nature and high power output, making it the most powerful naturally-aspirated production V8 engine of all time. ',
    },
    ...
    },
    {
      ...
      text: "The LT6 employs a dry-sump oil system, integrated into the engine, for better lubrication at high revs and during high-g cornering. It has six scavenging pumps.   The Corvette Eray's dry sump oil system is a standout feature designed for high-performance driving. Unlike traditional wet sump systems, the dry sump stores oil in an external reservoir, ensuring consistent lubrication even during extreme cornering, braking, or acceleration. This system minimizes oil aeration, enhances engine reliability, and allows the engine to sit lower in the vehicle, improving its center of gravity.  ",
    },
    {
    ...
    },
    {
      ...
      text: 'The Corvette LT6 engine for the Eray and GT3.R starts life at the Performance Build Center in Bowling Green, Kentucky, the same place all Corvette Eray engines are built.  ',
    },
  ];
    ...
    <div className="rowPage">
      ...
      <div className="col-6">
        <h1>
          ...
          <b> The <Link to="/Eray">2025 Corvette E-Ray </Link> Tech Talk </b>
        ...
        <h5>
          The Eray LT6 670-hp V-8 engine is a landmark achievement. Hagerty, February 21, 2022
        </h5>

        {/* <ul style={{ listStyleType: "none" }}> */}
        <h2>
          <p>
            The 2025 Chevrolet Corvette Eray is the most powerful Corvette
        ...
        <p>
          ...
          The LT6 is a 5.5-liter, naturally-aspirated, flat-plane V8 engine that debuted in the 2023 Chevrolet Corvette Eray, known for its high-revving nature and high power output, making it the most powerful naturally-aspirated production V8 engine of all time.
        </p>
        ...
        <div>
          ...
          <Link to="https://www.hagerty.com/media/maintenance-and-tech/lt6-breakdown-the-Erays-670-hp-v-8-is-a-landmark-achievement/          ">
