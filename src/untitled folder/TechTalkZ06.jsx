...
export default function TechTalkZ06 () {
  const sections = [
    {
    ...
    <div className="rowPage">
      ...
      <div className="col-6">
        <h1>
          ...
          <b> The <Link to="/Z06">2025 Corvette Z06 </Link> LT6 Engine </b>
        ...
        <h5>
          The Z06 LT6 670-hp V-8 engine is a landmark achievement. Hagerty, February 21, 2022
        </h5>

        {/* <ul style={{ listStyleType: "none" }}> */}
        <h2>
          <p>
            The 2025 Chevrolet Corvette Z06 is the most powerful Corvette
        ...
        <p>
          ...
          The LT6 is a 5.5-liter, naturally-aspirated, flat-plane V8 engine that debuted in the 2023 Chevrolet Corvette Z06, known for its high-revving nature and high power output, making it the most powerful naturally-aspirated production V8 engine of all time.
        </p>
