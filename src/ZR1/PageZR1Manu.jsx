...
export default function PageZR1Manu() {

//  2025 Corvette ZR1's Mechanical SECRETS (w/ Chief Engineer)
//  https://www.youtube.com/watch?v=ulPzur-SOcw&t=52s
  ...
  return (
    <>
      <div className="rowPage">
        ...
        <div className="col-6">
          <h1>
           <b>  Corvette ZR1 Vehicle Assembly  </b>
          </h1>
          <br />
          <h1> </h1>
