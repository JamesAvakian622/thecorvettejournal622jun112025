...
export default function PageZR1ExtSoc() {
  return (
    <>
...
<p> Corvette ZR1 Logo   </p>
          ...
          <div className="center">
            <h1>
              <b>
                <Link to="/ZR1">2025 Corvette ZR1 </Link> Exterior
              </b>
            </h1>
    ...
    <div>
      ...
      <YouTubeVideo title="2025 Corvette ZR1 LT7" videoId=" watch?v=9E4gxsMZ5UU&t=310s " /> */}
