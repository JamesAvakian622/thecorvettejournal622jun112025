...
export default function PageZR1Specs() {
  return (
    <>
      ...
      <div className="col-6">
        <h1>
          <b>2025 Corvette ZR1 Specifications          </b>
        </h1>
        ...
        <div className="center">
          <h2><b>    2025 Chevrolet Corvette ZR1 </b></h2>
          <h2> </h2>  <br />
          Base Price: $178,195
          <h2> </h2>  <br />

          1064 hp, 38731 lb, 3.6 lb/hp
          <h2> </h2>  <br />
          ...
          <Link to=" https://www.youtube.com/watch?v=ZSqnVobbLyU&t=196s" >  Car And Driver Results</Link>
