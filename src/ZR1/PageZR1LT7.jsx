...
// was SidebarZR1
export default function PageZR1LT7() {
  return (
    <>
      <div className="containerZ">
        ...
        <div className="col-6">
          <h1 className="center1">
            ...
            <b> The 2025 Corvette ZR1 LT7 Engine</b>
          </h1>
          ...
          <h1 className="center1">
            ...
            <Link to="../LT7"> The Corvette LT7 Engine </Link>
          </h1>
        ...
        <div className="responsive">
          ...
          <Link to="  https://gmauthority.com/blog/2025/04/31-workers-laid-off-indefinitely-at-corvette-bowling-green-assembly-plant/">
            3. GM Authority, "31 Workers Laid Off Indefinitely At Corvette Bowling Green Assembly Plant".
             ...
             <Link to="https://vette-vues.com/5-5l-dohc-v-8-engine-press-release/">    4. Vette Vues Magazine, "2023 C8 Corvette Z06 LT6 Debut: 5.5L DOHC V-8 Engine" </Link>
        </div>
        <Footer />
